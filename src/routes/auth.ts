...
import { registerUserSchema, loginUserSchema, forgotPasswordSchema } from '../schemas/user';
...
import { forgotPassword, getResetPasswordForm } from '../controllers/auth/reset-password';
